...
for contact_batch in client.get_contacts(group='everyone').iterfetches():
    for contact in (contact_batch):
        ...
        student=[c.get('name'), c.get('fields').get('studentname'), c.get('fields').get('next_pscl'), c.get('fields').get('open_pscl')]
        # print(student)
        # print([c.get('name'), c.get('fields').get('studentname'), c.get('fields').get('next_data'),c.get('fields').get('open_data')])

        student=[c.get('name'), c.get('fields').get('studentname'), 
                 c.get('fields').get('next_pscl'), c.get('fields').get('open_pscl'),
                 c.get('fields').get('next_combinatorics'), c.get('fields').get('open_combinatorics'),
                 c.get('fields').get('next_algebra'), c.get('fields').get('open_algebra'),
                 c.get('fields').get('next_numbers'), c.get('fields').get('open_numbers'),
                 c.get('fields').get('next_data'), c.get('fields').get('open_data'),
                 c.get('fields').get('next_geometry'), c.get('fields').get('open_geometry')
